...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Login__ = __webpack_require__(38);
    ...
    methods: {
        auth: function auth() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default()(options).then(function (response) {
                console.log('success');
                _this.userData.name = response.data.success.name;
            }).catch(function (e) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        greet: function greet(event) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/api/prod').then(function (response) {
  ...
  return _c("div", [
    ...
    _c("div", { staticClass: "panel panel-default" }, [
      ...
      _c("div", { staticClass: "panel-body" }, [
        ...
        _c(
          "form",
          { staticClass: "form-horizontal", attrs: { id: "formRegistration" } },
          [
            _c(
              "div",
              {
              ...
              [
                ...
                _c("div", { staticClass: "col-md-6" }, [
                  ...
                  _c(
                    ...
                    {
                      staticClass: "help-block",
                      class: { hide: !_vm.errors.password }
                    },
